...
- URL: https://huggingface.co/spaces/Chris4K/Advanced_Embeddings_Comparator
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/Advanced_Embeddings_Comparator/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/Advanced_Embeddings_Comparator
